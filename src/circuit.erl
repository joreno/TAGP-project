-module(circuit).
-export([createSimpleCircuit/0, createNPipes/1, createPipes/3, connectPipes/1, stop/0, getConnectors/1, createCircuit/0, createCircuitWithPump/0, createCircuitWithPumpAndFlowmeter/0, createFullCircuit/0, startSurvivor/0]).
...
createCircuit() ->
	...
	location:arrival(LocA, FluidumInst),
	location:arrival(LocB, FluidumInst),
	location:arrival(LocC, FluidumInst),
